LD_LIBRARY_PATH=/lib:/usr/lib:/bak/usr/lib:/bak/lib
...
####### set sd driver : 12mA #######
/bak/usr/local/bin/amba_debug -w 0xec17031c  -d  0xffffffff
/bak/usr/local/bin/amba_debug -w 0xec170320  -d  0xf9ffffff

/bak/usr/local/bin/amba_debug -w 0xec170324  -d  0xffffffff
/bak/usr/local/bin/amba_debug -w 0xec170328  -d  0xffffe1ff
